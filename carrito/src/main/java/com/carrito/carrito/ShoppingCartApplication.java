...
public class ShoppingCartApplication implements CommandLineRunner {
	...
	@Autowired
	private SpringDataUserRepository userRepository;         // <- Asegúrate de tener un repositorio
	@Autowired
	private SpringDataProductRepository productRepository;   //    Spring Data (o un adaptador)
	@Autowired
	private SpringDataCouponRepository couponRepository;     //    para cada entidad
	@Autowired
	...
	public void run(String... args) {
		...
		sd1.setProductId(p1.getProductId());  // Apunta al ID del producto
		sd1.setStartMonth(1);
		sd1.setEndMonth(6);
		sd1.setDiscountPercentage(5.0);       // 5% en primeros 6 meses
		...
		sd2.setStartMonth(7);
		sd2.setEndMonth(12);
		sd2.setDiscountPercentage(15.0);      // 15% en últimos 6 meses
